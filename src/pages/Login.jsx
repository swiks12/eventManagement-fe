            ...
            <div className='flex items-center space-x-[100px] bg-white w-[70vw] m-8 rounded-3xl bg-opacity-50'>
                ...
                <div>
                    ...
                    <form action="" className='flex flex-col gap-3'>
                        <input type="email" placeholder='Email' name='emailLogin' className='bg-white rounded-2xl p-[9px] w-[250px]'/>
                        <input type="password" placeholder="Password" name='passlogin' className='bg-white rounded-2xl p-[9px] w-[250px]'/>
                        <Button data="Log In"/>
