            ...
            {data.map((item,i)=>(
                ...
                <div key={i} className='p-4 border rounded-2xl shadow-xl mb-[30px]'>
                    ...
                    <div className="flex flex-row gap-3 mt-2">
                        <button className="bg-green-300  pl-3 pr-3 rounded-2xl place-self-end font-medium" onClick={() => handleApproval(item._id,"accepted")}>Accept</button>
                        <button className="bg-red-400  pl-3 pr-3 rounded-2xl place-self-end font-medium" onClick={() =>{handleApproval(item._id,"rejected")}}>Reject</button>
                    </div>
                    </div>
                </div>
